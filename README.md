# 工程简介
IP隧道服务，用于公司内部爬虫服务的代理IP的管理，分发和分配，优质ip筛选，并提供高效安全稳定的http代理服务。



# 需求分析
现在购买的第三方代理服务，会通过第三方接口返回对应的代理的ip和port，进而实现爬虫服务使用不同的代理IP去爬取数据。但是随着够买的第三方代理越来越多，有点难以管理，所以需要构建一个IP隧道服务，进而实现代理ip的统一管理，和动态分配。
...
```sql
----------------------- 并发数：10 ------------------------
IP=61.191.84.183:4216(2022-09-10 16:52:26), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.191.84.183:4216(2022-09-10 16:52:26), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.191.84.183:4216(2022-09-10 16:52:26), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=353 kb
IP=61.191.84.183:4216(2022-09-10 16:52:26), 并发=10, 成功=90, 失败=10, 失败率=10%, 平均响应报文大小=317 kb
IP=61.191.84.183:4216(2022-09-10 16:52:26), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
并发数：10, 耗时：43s
----------------------- 并发数：20 ------------------------
IP=117.57.21.75:4216(2022-09-10 16:52:26), 并发=20, 成功=200, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=117.57.21.75:4216(2022-09-10 16:52:26), 并发=20, 成功=200, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=117.57.21.75:4216(2022-09-10 16:52:26), 并发=20, 成功=147, 失败=53, 失败率=26.5%, 平均响应报文大小=259 kb
IP=117.57.21.75:4216(2022-09-10 16:52:26), 并发=20, 成功=200, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=117.57.21.75:4216(2022-09-10 16:52:26), 并发=20, 成功=200, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
并发数：20, 耗时：79s
----------------------- 并发数：30 ------------------------
IP=220.179.211.123:4216(2022-09-10 16:52:26), 并发=30, 成功=299, 失败=1, 失败率=0.33%, 平均响应报文大小=351 kb
IP=220.179.211.123:4216(2022-09-10 16:52:26), 并发=30, 成功=270, 失败=30, 失败率=10%, 平均响应报文大小=317 kb
IP=220.179.211.123:4216(2022-09-10 16:52:26), 并发=30, 成功=300, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=220.179.211.123:4216(2022-09-10 16:52:26), 并发=30, 成功=218, 失败=82, 失败率=27.33%, 平均响应报文大小=256 kb
IP=220.179.211.123:4216(2022-09-10 16:52:26), 并发=30, 成功=300, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
并发数：30, 耗时：112s
----------------------- 并发数：40 ------------------------
IP=114.99.7.128:4216(2022-09-10 16:52:26), 并发=40, 成功=400, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=114.99.7.128:4216(2022-09-10 16:52:26), 并发=40, 成功=320, 失败=80, 失败率=20%, 平均响应报文大小=282 kb
IP=114.99.7.128:4216(2022-09-10 16:52:26), 并发=40, 成功=400, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=114.99.7.128:4216(2022-09-10 16:52:26), 并发=40, 成功=360, 失败=40, 失败率=10%, 平均响应报文大小=317 kb
IP=114.99.7.128:4216(2022-09-10 16:52:26), 并发=40, 成功=400, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
并发数：40, 耗时：151s
----------------------- 并发数：50 ------------------------
IP=114.99.5.252:4216(2022-09-10 16:52:26), 并发=50, 成功=449, 失败=51, 失败率=10.2%, 平均响应报文大小=316 kb
IP=114.99.5.252:4216(2022-09-10 16:52:26), 并发=50, 成功=376, 失败=124, 失败率=24.8%, 平均响应报文大小=265 kb
IP=114.99.5.252:4216(2022-09-10 16:52:26), 并发=50, 成功=499, 失败=1, 失败率=0.2%, 平均响应报文大小=351 kb
IP=114.99.5.252:4216(2022-09-10 16:52:26), 并发=50, 成功=365, 失败=135, 失败率=27%, 平均响应报文大小=257 kb
IP=114.99.5.252:4216(2022-09-10 16:52:26), 并发=50, 成功=495, 失败=5, 失败率=1%, 平均响应报文大小=348 kb
并发数：50, 耗时：184s
```
...
```sql
----------------------- 并发数：10 ------------------------
IP=61.191.85.60:4216(2022-09-10 18:02:52), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.191.85.60:4216(2022-09-10 18:02:52), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.191.85.60:4216(2022-09-10 18:02:52), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.191.85.60:4216(2022-09-10 18:02:52), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.191.85.60:4216(2022-09-10 18:02:52), 并发=10, 成功=100, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
并发数：10, 耗时：40s
----------------------- 并发数：20 ------------------------
IP=114.99.13.58:4216(2022-09-10 18:02:55), 并发=20, 成功=144, 失败=56, 失败率=28%, 平均响应报文大小=253 kb
IP=114.99.13.58:4216(2022-09-10 18:02:55), 并发=20, 成功=200, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=114.99.13.58:4216(2022-09-10 18:02:55), 并发=20, 成功=200, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=114.99.13.58:4216(2022-09-10 18:02:55), 并发=20, 成功=200, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=114.99.13.58:4216(2022-09-10 18:02:55), 并发=20, 成功=149, 失败=51, 失败率=25.5%, 平均响应报文大小=262 kb
并发数：20, 耗时：78s
----------------------- 并发数：30 ------------------------
IP=61.132.171.69:4216(2022-09-10 18:02:58), 并发=30, 成功=300, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.132.171.69:4216(2022-09-10 18:02:58), 并发=30, 成功=300, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.132.171.69:4216(2022-09-10 18:02:58), 并发=30, 成功=270, 失败=30, 失败率=10%, 平均响应报文大小=317 kb
IP=61.132.171.69:4216(2022-09-10 18:02:58), 并发=30, 成功=300, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=61.132.171.69:4216(2022-09-10 18:02:58), 并发=30, 成功=212, 失败=88, 失败率=29.33%, 平均响应报文大小=249 kb
并发数：30, 耗时：117s
----------------------- 并发数：40 ------------------------
IP=114.99.13.65:4216(2022-09-10 18:03:00), 并发=40, 成功=400, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=114.99.13.65:4216(2022-09-10 18:03:00), 并发=40, 成功=294, 失败=106, 失败率=26.5%, 平均响应报文大小=258 kb
IP=114.99.13.65:4216(2022-09-10 18:03:00), 并发=40, 成功=400, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
IP=114.99.13.65:4216(2022-09-10 18:03:00), 并发=40, 成功=317, 失败=83, 失败率=20.75%, 平均响应报文大小=279 kb
IP=114.99.13.65:4216(2022-09-10 18:03:00), 并发=40, 成功=400, 失败=0, 失败率=0%, 平均响应报文大小=352 kb
并发数：40, 耗时：145s
----------------------- 并发数：50 ------------------------
IP=60.173.35.211:4216(2022-09-10 18:03:06), 并发=50, 成功=367, 失败=133, 失败率=26.6%, 平均响应报文大小=259 kb
IP=60.173.35.211:4216(2022-09-10 18:03:06), 并发=50, 成功=496, 失败=4, 失败率=0.8%, 平均响应报文大小=349 kb
IP=60.173.35.211:4216(2022-09-10 18:03:06), 并发=50, 成功=373, 失败=127, 失败率=25.4%, 平均响应报文大小=262 kb
IP=60.173.35.211:4216(2022-09-10 18:03:06), 并发=50, 成功=499, 失败=1, 失败率=0.2%, 平均响应报文大小=351 kb
IP=60.173.35.211:4216(2022-09-10 18:03:06), 并发=50, 成功=368, 失败=132, 失败率=26.4%, 平均响应报文大小=259 kb
并发数：50, 耗时：174s
```
...
```sql
# connect请求转发流程
schema.channelActive() -> 
tunnel.channelActive() -> 
schema.channelRead() -> 
tunnel.channelRead() -> 
TunnelRelayHandler.channelActive() -> 
TunnelRelayHandler.channelRead() -> 
TunnelRelayHandler.channelInactive()
