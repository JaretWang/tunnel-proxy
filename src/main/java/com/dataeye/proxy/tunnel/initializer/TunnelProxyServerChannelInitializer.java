...
public class TunnelProxyServerChannelInitializer extends ChannelInitializer<SocketChannel> {
    ...
    public TunnelProxyServerChannelInitializer(ProxyServerConfig proxyServerConfig, ProxySslContextFactory proxySslContextFactory){
    ...
    protected void initChannel(SocketChannel ch) {
        ...
        // 隧道代理
        pipeline.addLast(TunnelProxyHandler.HANDLER_NAME, new TunnelProxyHandler(proxyServerConfig, proxySslContextFactory));
    }
}
