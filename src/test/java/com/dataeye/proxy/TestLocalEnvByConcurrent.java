...
//    private static final String proxyIp = "182.204.157.133";
    ...
    private static final int totalTask = totalNum * 3;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String percent = getPercent(errorTotal, totalTask);
...
//        System.out.println("total：" + total + ", ok: " + ok + ", error: " + error);
    ...
    static String getPercent(float num1, float num2) {
